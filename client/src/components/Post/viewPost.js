...
export default function ViewPost() {
  ...
  useEffect(() => {
    async function getPostData() {
      ...
      console.log(postInfo.likes !== null);
  ...
  function PostLikes() {
    return postInfo.likes !== undefined &&
      <>
        <div>
          <Link onClick={() => { toggleLikeComment(); }}>
            <button >
  ...
  return (
    <div class="page-container">
      ...
      <h5>by {postInfo.user} at 11:60PM</h5>
      <br />
      ...
      <div class="info-container">
        ...
        <div><h5>{postInfo.comments !== undefined && postInfo.comments.length} comments</h5></div>
        <div><p></p></div>
      </div>
