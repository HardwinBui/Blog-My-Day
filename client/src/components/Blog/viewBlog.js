...
export default function RecordList() {
 ...
 useEffect(() => {
   async function getRecords() {
     const response = await fetch(`http://blogmydaybackend.onrender.com/post/`);
     const response2 = await fetch(`http://blogmydaybackend.onrender.com/blog/${params.id}`);
     const response3 = await fetch(`http://blogmydaybackend.onrender.com/comment`);
